...
\begin{table}
\caption{SpecialIssue  }

\begin{longtable}{llp{8cm}}
& Attribute & Description \\
$\square$\ & shortName &  \\
$\square$\ & topic &  \\
$\square$\ & basedOnConference &  \\
\end{longtable}
\label{attr:SpecialIssue}
\end{table}
