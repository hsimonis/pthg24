...
\bottomrule
\endfoot
LiuGT10 \href{http://dx.doi.org/10.3724/sp.j.1004.2010.00603}{LiuGT10} & \hyperref[auth:a1219]{S.-X. Liu}, \hyperref[auth:a1220]{Z. Guo}, \hyperref[auth:a1221]{J.-F. Tang} & Constraint Propagation for Cumulative Scheduling Problems with Precedences: Constraint Propagation for Cumulative Scheduling Problems with Precedences & \hyperref[detail:LiuGT10]{Details} \href{../scheduling/works/LiuGT10.pdf}{Yes} & \cite{LiuGT10} & 2010 & \cellcolor{red!20}Acta Automatica Sinica & 7 & \noindent{}\textbf{1.50} \textbf{1.50} 0.70 & 2 2 9 & 15 20 & 0 0 0\\
\end{longtable}
}

\subsection{Advanced Engineering Informatics}

\index{Advanced Engineering Informatics}
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Advanced Engineering Informatics (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Zhang2025b \href{https://doi.org/10.1016/j.aei.2025.103210}{Zhang2025b} & \hyperref[auth:a2180]{M. Zhang}, \hyperref[auth:a2181]{X. Li}, \hyperref[auth:a1972]{L. Gao}, \hyperref[auth:a2182]{Q. Liu} & Constraint programming-based layered method for integrated process planning and scheduling in extensive flexible manufacturing & \cellcolor{red!30}\hyperref[detail:Zhang2025b]{Details} No & \cite{Zhang2025b} & 2025 & Advanced Engineering Informatics & null & \noindent{}\textbf{1.00} \textbf{1.00} n/a & 0 7 4 & 0 53 & 0 0 0\\
\end{longtable}
}
...
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Annals of Operations Research (Total 23)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Laalaoui2024 \href{https://doi.org/10.1007/s10479-024-06386-7}{Laalaoui2024} & \hyperref[auth:a2114]{Y. Laalaoui}, \hyperref[auth:a2115]{R. M’Hallah} & \cellcolor{gold!20}Enhancing the best-first-search F with incremental search and restarts for large-scale single machine scheduling with release dates and deadlines \hyperref[abs:Laalaoui2024]{Abstract} & \hyperref[detail:Laalaoui2024]{Details} \href{../scheduling/works/Laalaoui2024.pdf}{Yes} & \cite{Laalaoui2024} & 2024 & Annals of Operations Research & 30 & \noindent{}\textcolor{black!50}{0.00} \textbf{5.00} \textbf{16.09} & 0 0 0 & 0 43 & 0 0 0\\
...
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Constraints An Int. J. (Total 48)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Marty2024 \href{https://doi.org/10.1007/s10601-024-09377-4}{Marty2024} & \hyperref[auth:a2183]{T. Marty}, \hyperref[auth:a2184]{L. Boisvert}, \hyperref[auth:a2185]{T. François}, \hyperref[auth:a2186]{P. Tessier}, \hyperref[auth:a2187]{L. Gautier}, \hyperref[auth:a326]{L.-M. Rousseau}, \hyperref[auth:a42]{Q. Cappart} & \cellcolor{gold!20}Learning and fine-tuning a generic value-selection heuristic inside a constraint programming solver \hyperref[abs:Marty2024]{Abstract} & \hyperref[detail:Marty2024]{Details} \href{../scheduling/works/Marty2024.pdf}{Yes} & \cite{Marty2024} & 2024 & Constraints An Int. J. & 27 & \noindent{}\textcolor{black!50}{0.00} \textbf{1.00} \textbf{2.60} & 0 0 1 & 0 0 & 0 0 0\\
...
\bottomrule
\endfoot
MengLZB21 \href{http://dx.doi.org/10.1049/cim2.12005}{MengLZB21} & \hyperref[auth:a499]{L. Meng}, \hyperref[auth:a1156]{C. Lu}, \hyperref[auth:a502]{B. Zhang}, \hyperref[auth:a501]{Y. Ren}, \hyperref[auth:a503]{C. Lv}, \hyperref[auth:a1157]{H. Sang}, \hyperref[auth:a1158]{J. Li}, \hyperref[auth:a500]{C. Zhang} & \cellcolor{gold!20}Constraint programing for solving four complex flexible shop scheduling problems & \hyperref[detail:MengLZB21]{Details} \href{../scheduling/works/MengLZB21.pdf}{Yes} & \cite{MengLZB21} & 2021 & IET Collaborative Intelligent Manufacturing & 14 & \noindent{}\textcolor{black!50}{0.00} \textcolor{black!50}{0.00} \textbf{28.91} & 8 8 8 & 39 44 & 5 5 0\\
\end{longtable}
}

\subsection{IET Intelligent Transport Systems}

\index{IET Intelligent Transport Systems}
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal IET Intelligent Transport Systems (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Ma2025 \href{https://doi.org/10.1049/itr2.70023}{Ma2025} & \hyperref[auth:a2130]{L. Ma}, \hyperref[auth:a2131]{J. Guo}, \hyperref[auth:a2132]{Y. Bao}, \hyperref[auth:a2133]{S. Tao} & \cellcolor{gold!20}A Two‐Step Method for the Operation Rescheduling Problem at the Railway Marshalling Station \hyperref[abs:Ma2025]{Abstract} & \hyperref[detail:Ma2025]{Details} \href{../scheduling/works/Ma2025.pdf}{Yes} & \cite{Ma2025} & 2025 & IET Intelligent Transport Systems & 26 & \noindent{}\textcolor{black!50}{0.00} \textbf{2.25} \textbf{2.77} & 0 0 0 & 0 37 & 0 0 0\\
\end{longtable}
}
...
\subsection{Informatics and Automation}

\index{Informatics and Automation}
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Informatics and Automation (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Zuenko2024 \href{https://doi.org/10.15622/ia.23.5.1}{Zuenko2024} & \hyperref[auth:a1991]{A. Zuenko}, \hyperref[auth:a1992]{Y. Oleynik} & \cellcolor{gold!20}Scheduling as a Constraint Satisfaction Problem (Using the Example of Open-Pit Minе Production Scheduling Problem) \hyperref[abs:Zuenko2024]{Abstract} & \cellcolor{red!30}\hyperref[detail:Zuenko2024]{Details} No & \cite{Zuenko2024} & 2024 & Informatics and Automation & null & \noindent{}\textbf{1.00} \textbf{3.00} n/a & 0 0 0 & 0 18 & 0 0 0\\
\end{longtable}
}
...
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal International Transactions in Operational Research (Total 3)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Yuraszeck2024 \href{https://doi.org/10.1111/itor.13504}{Yuraszeck2024} & \hyperref[auth:a405]{F. Yuraszeck}, \hyperref[auth:a741]{G. Mejía}, \hyperref[auth:a2142]{A. Lüer‐Villagra} & An adapted constraint‐programming formulation of the resource‐constrained project scheduling problem applied to the identical parallel machines group shop and mixed shop scheduling problems \hyperref[abs:Yuraszeck2024]{Abstract} & \cellcolor{red!30}\hyperref[detail:Yuraszeck2024]{Details} No & \cite{Yuraszeck2024} & 2024 & International Transactions in Operational Research & null & \noindent{}\textcolor{black!50}{0.00} \textbf{2.00} n/a & 0 0 0 & 0 40 & 0 0 0\\
Chakrabortty2019 \href{http://dx.doi.org/10.1111/itor.12644}{Chakrabortty2019} & \hyperref[auth:a1612]{R. K. Chakrabortty}, \hyperref[auth:a1613]{A. Abbasi}, \hyperref[auth:a1614]{M. J. Ryan} & \cellcolor{gold!20}Multi‐mode resource‐constrained project scheduling using modified variable neighborhood search heuristic \hyperref[abs:Chakrabortty2019]{Abstract} & \hyperref[detail:Chakrabortty2019]{Details} \href{../scheduling/works/Chakrabortty2019.pdf}{Yes} & \cite{Chakrabortty2019} & 2019 & International Transactions in Operational Research & 30 & \noindent{}\textcolor{black!50}{0.00} \textcolor{black!50}{0.00} 0.22 & 44 37 41 & 81 85 & 4 4 0\\
Ribeiro12 \href{http://dx.doi.org/10.1111/j.1475-3995.2011.00819.x}{Ribeiro12} & \hyperref[auth:a1385]{C. C. Ribeiro} & Sports scheduling: Problems and applications \hyperref[abs:Ribeiro12]{Abstract} & \hyperref[detail:Ribeiro12]{Details} \href{../scheduling/works/Ribeiro12.pdf}{Yes} & \cite{Ribeiro12} & 2012 & International Transactions in Operational Research & 26 & \noindent{}\textcolor{black!50}{0.00} \textbf{1.00} \textbf{1.64} & 56 52 54 & 0 92 & 2 2 0\\
\end{longtable}
}
...
\bottomrule
\endfoot
Paredis1992 \href{http://dx.doi.org/10.1080/12460125.1992.10511509}{Paredis1992} & \hyperref[auth:a1995]{J. Paredis}, \hyperref[auth:a1996]{T. van Rij} & Simulation and Constraint Programming as Support Methodologies for Job Shop Scheduling & \cellcolor{red!30}\hyperref[detail:Paredis1992]{Details} No & \cite{Paredis1992} & 1992 & Journal of Decision Systems & null & \noindent{}\textbf{2.00} \textbf{2.00} n/a & 2 2 5 & 0 15 & 1 1 0\\
\end{longtable}
}

\subsection{Journal of Educational Measurement}

\index{Journal of Educational Measurement}
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Journal of Educational Measurement (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Li2018a \href{https://doi.org/10.1111/jedm.12187}{Li2018a} & \hyperref[auth:a2193]{J. Li}, \hyperref[auth:a2194]{Wim J. van der Linden} & A Comparison of Constraint Programming and Mixed‐Integer Programming for Automated Test‐Form Generation \hyperref[abs:Li2018a]{Abstract} & \cellcolor{red!30}\hyperref[detail:Li2018a]{Details} No & \cite{Li2018a} & 2018 & Journal of Educational Measurement & null & \noindent{}\textcolor{black!50}{0.00} \textbf{2.00} n/a & 3 4 3 & 11 17 & 1 1 0\\
\end{longtable}
}
...
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Machines (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Zhao2024 \href{https://doi.org/10.3390/machines12090666}{Zhao2024} & \hyperref[auth:a2154]{W. Zhao}, \hyperref[auth:a2155]{J. Hu}, \hyperref[auth:a2156]{J. Lu}, \hyperref[auth:a2157]{W. Zhang} & \cellcolor{gold!20}Cyber-Physical Scheduling System for Multiobjective Scheduling Optimization of a Suspension Chain Workshop Using the Improved Non-Dominated Sorting Genetic Algorithm II \hyperref[abs:Zhao2024]{Abstract} & \cellcolor{red!30}\hyperref[detail:Zhao2024]{Details} No & \cite{Zhao2024} & 2024 & Machines & null & \noindent{}\textcolor{black!50}{0.00} \textbf{1.50} n/a & 0 0 0 & 0 58 & 0 0 0\\
\end{longtable}
}
...
\bottomrule
\endfoot
Xidias2019 \href{http://dx.doi.org/10.1017/dsi.2019.292}{Xidias2019} & \hyperref[auth:a1986]{E. Xidias}, \hyperref[auth:a1987]{P. Azariadis} & \cellcolor{gold!20}Energy Efficient Motion Design and Task Scheduling for an Autonomous Vehicle \hyperref[abs:Xidias2019]{Abstract} & \hyperref[detail:Xidias2019]{Details} \href{../scheduling/works/Xidias2019.pdf}{Yes} & \cite{Xidias2019} & 2019 & Proceedings of the Design Society: International Conference on Engineering Design & 10 & \noindent{}\textcolor{black!50}{0.00} \textbf{2.00} \textcolor{black!50}{0.04} & 1 2 3 & 16 19 & 0 0 0\\
\end{longtable}
}

\subsection{Proceedings of the Institution of Mechanical Engineers, Part B: Journal of Engineering Manufacture}

\index{Proceedings of the Institution of Mechanical Engineers, Part B: Journal of Engineering Manufacture}
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Proceedings of the Institution of Mechanical Engineers, Part B: Journal of Engineering Manufacture (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Baykasolu2017 \href{https://doi.org/10.1177/0954405416682281}{Baykasolu2017} & \hyperref[auth:a2206]{A. Baykasoğlu}, \hyperref[auth:a2207]{Şeyda Topaloğlu}, \hyperref[auth:a2208]{F. Şenyüzlüler} & Manufacturing cell formation with flexible processing capabilities and worker assignment: Comparison of constraint programming and integer programming approaches \hyperref[abs:Baykasolu2017]{Abstract} & \cellcolor{red!30}\hyperref[detail:Baykasolu2017]{Details} No & \cite{Baykasolu2017} & 2017 & Proceedings of the Institution of Mechanical Engineers, Part B: Journal of Engineering Manufacture & null & \noindent{}\textcolor{black!50}{0.00} \textbf{1.00} n/a & 8 8 9 & 31 45 & 1 1 0\\
\end{longtable}
}
...
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal Proceedings of the International Conference on Automated Planning and Scheduling (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Booth2018 \href{https://doi.org/10.1609/icaps.v28i1.13920}{Booth2018} & \hyperref[auth:a2145]{K. Booth}, \hyperref[auth:a808]{M. Do}, \hyperref[auth:a2146]{J. Beck}, \hyperref[auth:a2147]{E. Rieffel}, \hyperref[auth:a811]{D. Venturelli}, \hyperref[auth:a379]{J. Frank} & \cellcolor{gold!20}Comparing and Integrating Constraint Programming and Temporal Planning for Quantum Circuit Compilation \hyperref[abs:Booth2018]{Abstract} & \cellcolor{red!30}\hyperref[detail:Booth2018]{Details} No & \cite{Booth2018} & 2018 & Proceedings of the International Conference on Automated Planning and Scheduling & null & \noindent{}\textcolor{black!50}{0.00} \textbf{2.00} n/a & 35 34 57 & 3 0 & 1 0 1\\
\end{longtable}
}
...
\bottomrule
\endfoot
Caricato2020 \href{http://dx.doi.org/10.1007/s00170-020-06176-y}{Caricato2020} & \hyperref[auth:a1497]{P. Caricato}, \hyperref[auth:a1498]{A. Grieco}, \hyperref[auth:a1499]{A. Arigliano}, \hyperref[auth:a1500]{L. Rondone} & \cellcolor{gold!20}Workforce influence on manufacturing machines schedules \hyperref[abs:Caricato2020]{Abstract} & \hyperref[detail:Caricato2020]{Details} \href{../scheduling/works/Caricato2020.pdf}{Yes} & \cite{Caricato2020} & 2020 & The International Journal of Advanced Manufacturing Technology & 11 & \noindent{}\textcolor{black!50}{0.00} \textbf{3.00} \textbf{7.44} & 5 4 3 & 20 27 & 2 2 0\\
\end{longtable}
}

\subsection{The Journal of Engineering}

\index{The Journal of Engineering}
{\scriptsize
\begin{longtable}{>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{4.5cm}>{\raggedright\arraybackslash}p{6.0cm}p{1.0cm}rr>{\raggedright\arraybackslash}p{2.0cm}r>{\raggedright\arraybackslash}p{1cm}p{1cm}p{1cm}p{1cm}}
\rowcolor{white}\caption{Articles in Journal The Journal of Engineering (Total 1)}\\ \toprule
\rowcolor{white}\shortstack{Key\\Source} & Authors & Title (Colored by Open Access)& \shortstack{Details\\LC} & Cite & Year & \shortstack{Conference\\/Journal\\/School} & Pages & Relevance &\shortstack{Cites\\OC XR\\SC} & \shortstack{Refs\\OC\\XR} & \shortstack{Links\\Cites\\Refs}\\ \midrule\endhead
\bottomrule
\endfoot
Zhang2024 \href{https://doi.org/10.1049/tje2.12368}{Zhang2024} & \hyperref[auth:a2172]{Z. Zhang}, \hyperref[auth:a2173]{C. Xiao}, \hyperref[auth:a2174]{S. Wang}, \hyperref[auth:a2175]{W. Yu}, \hyperref[auth:a2176]{Y. Bai} & Automatic constraint programming solver selection method based on machine learning for the cable tree wiring problem \hyperref[abs:Zhang2024]{Abstract} & \hyperref[detail:Zhang2024]{Details} \href{../scheduling/works/Zhang2024.pdf}{Yes} & \cite{Zhang2024} & 2024 & The Journal of Engineering & 15 & \noindent{}0.50 \textbf{1.00} \textbf{4.83} & 0 1 0 & 0 52 & 0 0 0\\
\end{longtable}
}
