...
symbolic x coords={CP,CPAIOR,ICAPS,AAAI,ECAI,IJCAI,ICAART,ICRA,INAP,CSCLP,ICTAI,ICNSC,GOR,PACT},
...
\begin{tikzpicture}
\begin{axis}[title=Nr Citation Distribution Plot ,xlabel=Nr Citations,ylabel=Nr Works,grid=both,major grid style={gray,line width=0.1},,width=25cm,height=15cm]
\addplot+[] coordinates {
    (1.00000,57.0000)
    (2.00000,42.0000)
    (3.00000,36.0000)
