...
*/
    ...
    private transient BooleanProperty isOriginalWrapper;
...
*/
    ...
    public BooleanProperty isOriginalWrapperProperty() {
        if (isOriginalWrapper == null) {
            isOriginalWrapper = new SimpleBooleanProperty();
        }
        isOriginalWrapper.set(isOriginal);
        return isOriginalWrapper;
    }
...
/**
 *  set attribute isOriginal, mark dataset as dirty, mark dataset as not valid
...
*/
    ...
    String toXMLIsOriginal(){
        return this.getIsOriginal().toString();
    }
...
*/
    ...
    public Boolean applicationEqual(Article b){
      ...
      if(!this.getIsOriginal().equals(b.getIsOriginal())){
      ...
      if(!(getSpecialIssue() == null ? b.getSpecialIssue() == null:this.getSpecialIssue().applicationSame(b.getSpecialIssue()))){
         System.out.println("SpecialIssue");
        }
      ...
      if(!this.getYear().equals(b.getYear())){
        ...
        return  this.getAbstractText().equals(b.getAbstractText()) &&
          ...
          this.getIsOriginal().equals(b.getIsOriginal()) &&
          ...
          (this.getSpecialIssue() == null ? b.getSpecialIssue() == null : this.getSpecialIssue().applicationSame(b.getSpecialIssue())) &&
...
*/
    ...
    public void check(){
        ...
        if (getAwards() == null){
         new ApplicationWarning(getApplicationDataset(),ApplicationDataset.getIdNr(),toColumnString(),"awards","Article",(getAwards()==null?"null":getAwards().toString()),"",WarningType.NOTNULL);
        }
        if (getConcept() == null){
         new ApplicationWarning(getApplicationDataset(),ApplicationDataset.getIdNr(),toColumnString(),"concept","Article",(getConcept()==null?"null":getConcept().toString()),"",WarningType.NOTNULL);
        }
        if (getPublisher() == null){
         new ApplicationWarning(getApplicationDataset(),ApplicationDataset.getIdNr(),toColumnString(),"publisher","Article",(getPublisher()==null?"null":getPublisher().toString()),"",WarningType.NOTNULL);
        }
        if (getSourceGroup() == null){
         new ApplicationWarning(getApplicationDataset(),ApplicationDataset.getIdNr(),toColumnString(),"sourceGroup","Article",(getSourceGroup()==null?"null":getSourceGroup().toString()),"",WarningType.NOTNULL);
        }
        if (getJournal() == null){
