...
*/
    ...
    public void check(){
        ...
        if (getAwards() == null){
         new ApplicationWarning(getApplicationDataset(),ApplicationDataset.getIdNr(),toColumnString(),"awards","Paper",(getAwards()==null?"null":getAwards().toString()),"",WarningType.NOTNULL);
        }
        if (getConcept() == null){
