...
public SubType getSubType(String attributeName,
    ...
    public Assertion getAssertion(String attributeName,
                               Attributes attributes) {
        return (Assertion) find(getId(attributeName,attributes));
    }

    public List<Assertion> getAssertionCollectionFromIds(String attributeName,
                                     Attributes attributes) {
        String e = attributes.getValue(attributeName);
        String[] words = e.split(" ");
        List<Assertion> res = new ArrayList<Assertion>();
        for (int i = 0; i < words.length; i++) {
            if (words[i].length() > 0) {
                int id = Integer.parseInt(words[i].substring(3));
                res.add((Assertion) find(id));
            }
        }
        return res;
    }
    ...
    public ConnectedComponent getConnectedComponent(String attributeName,
                               Attributes attributes) {
        return (ConnectedComponent) find(getId(attributeName,attributes));
    }

    public List<ConnectedComponent> getConnectedComponentCollectionFromIds(String attributeName,
                                     Attributes attributes) {
        String e = attributes.getValue(attributeName);
        String[] words = e.split(" ");
        List<ConnectedComponent> res = new ArrayList<ConnectedComponent>();
        for (int i = 0; i < words.length; i++) {
            if (words[i].length() > 0) {
                int id = Integer.parseInt(words[i].substring(3));
                res.add((ConnectedComponent) find(id));
            }
        }
        return res;
    }
        ...
        public void startElement(String uri,
            ...
            if (qname.equals("body")) {
                ...
                store(id, new Article(base,
                        ...
                        getInteger("daysToAccept",attributes,0),
                        getInteger("daysToPublish",attributes,0),
                        getString("doi",attributes,""),
                        getBoolean("doiStatus",attributes,false),
                        getString("firstOnline",attributes,""),
                        ...
                        getInteger("nrHyperLinks",attributes,0),
                        ...
                        getBoolean("isOriginal",attributes,false),
                        null,
                        null
                        ));
            ...
            } else if (qname.equals("connectedComponent")) {
                assert (base != null);
                int id = getId("id", attributes);
                store(id, new ConnectedComponent(base,
                        id,
                        getString("name", attributes, "dummy"),
                        getInteger("nr",attributes,0),
                        null
                ...
                store(id, new SpecialIssue(base,
                        id,
                        getString("name", attributes, "dummy"),
                        getBoolean("basedOnConference",attributes,false),
                        getString("shortName",attributes,""),
    ...
    private class Phase2Handler extends DefaultHandler {
        ...
        public void startElement(String uri,
            ...
            if (qname.equals("body")) {
                ...
                assert (base != null);
                int id = getId("id", attributes);
                Assertion item = (Assertion) find(id);
                ...
                assert (base != null);
                int id = getId("id", attributes);
                ConnectedComponent item = (ConnectedComponent) find(id);
                 item.setWorks(getWorkCollectionFromIds("works",attributes));
            } else if (qname.equals("countryCollab")) {
                assert (base != null);
                int id = getId("id", attributes);
