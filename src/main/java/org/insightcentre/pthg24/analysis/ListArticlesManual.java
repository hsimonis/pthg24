...
public class ListArticlesManual {
    public ListArticlesManual(Scenario base, String exportDir, String fileName){
    ...
    public static List<Article> sortedArticles(Scenario base){
