...
public class MissingCitedWorkController extends Table3Controller {
	...
	@FXML
	private TableColumn<MissingCitedWork, String> name;

	@FXML
	private TableColumn<MissingCitedWork, String> doi;

	@FXML
	private TableColumn<MissingCitedWork, Integer> nrCitations;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getMissingCitedWorkData());
	}

	public TableView<MissingCitedWork> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getMissingCitedWorkData());
		try {
			ObservableList<MissingCitedWork> filteredItems = FXCollections.observableArrayList();
			for (MissingCitedWork item : table.getItems()) {
