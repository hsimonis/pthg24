...
public class InCollectionController extends Table3Controller {
	...
	@FXML
	private TableColumn<InCollection, Integer> nrEdges;

	@FXML
	private TableColumn<InCollection, Integer> cluster;
	...
	@FXML
	private TableColumn<InCollection, Publisher> publisher;
	...
	@FXML
	private TableColumn<InCollection, String> issn;
	...
	@FXML
	private TableColumn<InCollection, Integer> nrHyperLinks;
	...
	@FXML
	private TableColumn<InCollection, String> classification;

	@FXML
	private TableColumn<InCollection, String> constraints;

	@FXML
	private TableColumn<InCollection, String> relatedTo;

	@FXML
	private TableColumn<InCollection, String> openAccess;

	@FXML
	private TableColumn<InCollection, OpenAccessType> openAccessType;

	@FXML
	private TableColumn<InCollection, Integer> nrConcepts;
	...
	@FXML
	private TableColumn<InCollection, Integer> crossrefCitations;

	@FXML
	private TableColumn<InCollection, Integer> crossrefReferences;

	@FXML
	private TableColumn<InCollection, Integer> wosCitations;

	@FXML
	private TableColumn<InCollection, Integer> wosReferences;

	@FXML
	private TableColumn<InCollection, Integer> scopusCitations;

	@FXML
	private TableColumn<InCollection, Integer> nrCitationsCovered;

	@FXML
	private TableColumn<InCollection, Integer> nrReferencesCovered;

	@FXML
	private TableColumn<InCollection, Double> percentCitationsCovered;

	@FXML
	private TableColumn<InCollection, Double> percentReferencesCovered;

	@FXML
	private TableColumn<InCollection, Integer> maxCitations;

	@FXML
	private TableColumn<InCollection, Integer> rangeCitations;

	@FXML
	private TableColumn<InCollection, Boolean> doiStatus;

	@FXML
	private TableColumn<InCollection, Boolean> crossrefStatus;

	@FXML
	private TableColumn<InCollection, Boolean> scopusStatus;

	@FXML
	private TableColumn<InCollection, Boolean> wosStatus;

	@FXML
	private TableColumn<InCollection, Double> relevanceTitle;

	@FXML
	private TableColumn<InCollection, Double> relevanceAbstract;
	...
	@FXML
	private TableColumn<InCollection, String> keywords;
