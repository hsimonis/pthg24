...
public class ApplicationDifferenceController extends Table3Controller {
	...
	@FXML
	private TableColumn<ApplicationDifference, String> name;

	@FXML
	private TableColumn<ApplicationDifference, DifferenceType> type;

	@FXML
	private TableColumn<ApplicationDifference, String> item;
	...
	public TableView<ApplicationDifference> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getApplicationDifferenceData());
		try {
			ObservableList<ApplicationDifference> filteredItems = FXCollections.observableArrayList();
			for (ApplicationDifference item : table.getItems()) {
