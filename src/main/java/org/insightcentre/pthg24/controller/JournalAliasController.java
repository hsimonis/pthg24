...
public class JournalAliasController extends Table3Controller {
	...
	@FXML
	private TableColumn<JournalAlias, String> name;

	@FXML
	private TableColumn<JournalAlias, Journal> journal;

	@FXML
	private TableColumn<JournalAlias, String> alias;
	...
	public TableView<JournalAlias> getTable() {
		return table;
	}
	...
	private void initialize() {
		...
		alias.setOnEditCommit(event -> {table.getSelectionModel().getSelectedItem().setAlias(event.getNewValue()); mainApp.reset();});
		initialize(choices);
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getJournalAliasData());
		try {
			ObservableList<JournalAlias> filteredItems = FXCollections.observableArrayList();
			for (JournalAlias item : table.getItems()) {
