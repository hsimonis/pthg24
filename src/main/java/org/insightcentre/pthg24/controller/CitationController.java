...
public class CitationController extends Table3Controller {
	...
	@FXML
	private TableColumn<Citation, String> name;

	@FXML
	private TableColumn<Citation, String> oci;

	@FXML
	private TableColumn<Citation, Work> citedWork;

	@FXML
	private TableColumn<Citation, Work> citingWork;

	@FXML
	private TableColumn<Citation, String> cited;

	@FXML
	private TableColumn<Citation, String> citing;

	@FXML
	private TableColumn<Citation, String> creation;

	@FXML
	private TableColumn<Citation, String> timespan;

	@FXML
	private TableColumn<Citation, String> authorSC;

	@FXML
	private TableColumn<Citation, String> journalSC;
	...
	public TableView<Citation> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getCitationData());
		try {
			ObservableList<Citation> filteredItems = FXCollections.observableArrayList();
			for (Citation item : table.getItems()) {
