...
public class CrossReferenceController extends Table3Controller {
	@FXML
	private TableView<CrossReference> table;

	@FXML
	private TableColumn<CrossReference, String> name;

	@FXML
	private TableColumn<CrossReference, String> key;

	@FXML
	private TableColumn<CrossReference, Work> work;

	@FXML
	private TableColumn<CrossReference, Work> referredWork;

	@FXML
	private TableColumn<CrossReference, MissingWork> missingWork;

	@FXML
	private TableColumn<CrossReference, MissingCross> missingCross;

	@FXML
	private TableColumn<CrossReference, Integer> year;

	@FXML
	private TableColumn<CrossReference, String> author;

	@FXML
	private TableColumn<CrossReference, String> source;

	@FXML
	private TableColumn<CrossReference, String> title;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getCrossReferenceData());
	...
	public TableView<CrossReference> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getCrossReferenceData());
		try {
			ObservableList<CrossReference> filteredItems = FXCollections.observableArrayList();
			for (CrossReference item : table.getItems()) {
