...
public class PaperController extends Table3Controller {
	...
	@FXML
	private TableColumn<Paper, String> keywords;
	...
	@FXML
	private TableColumn<Paper, String> received;

	@FXML
	private TableColumn<Paper, String> accepted;

	@FXML
	private TableColumn<Paper, String> revised;

	@FXML
	private TableColumn<Paper, String> firstOnline;

	@FXML
	private TableColumn<Paper, String> published;

	@FXML
	private TableColumn<Paper, Integer> daysToAccept;

	@FXML
	private TableColumn<Paper, Integer> daysToPublish;
