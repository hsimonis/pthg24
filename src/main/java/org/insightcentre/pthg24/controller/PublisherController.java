...
public class PublisherController extends Table3Controller {
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getPublisherData());
	}

	public TableView<Publisher> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getPublisherData());
		try {
			ObservableList<Publisher> filteredItems = FXCollections.observableArrayList();
			for (Publisher item : table.getItems()) {
