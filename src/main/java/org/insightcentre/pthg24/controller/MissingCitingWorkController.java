...
public class MissingCitingWorkController extends Table3Controller {
	@FXML
	private TableView<MissingCitingWork> table;

	@FXML
	private TableColumn<MissingCitingWork, String> name;

	@FXML
	private TableColumn<MissingCitingWork, String> doi;

	@FXML
	private TableColumn<MissingCitingWork, Integer> nrCited;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getMissingCitingWorkData());
	}

	public TableView<MissingCitingWork> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getMissingCitingWorkData());
		try {
			ObservableList<MissingCitingWork> filteredItems = FXCollections.observableArrayList();
			for (MissingCitingWork item : table.getItems()) {
