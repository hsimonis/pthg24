...
public class SchoolController extends Table3Controller {
	...
	@FXML
	private TableColumn<School, String> name;
	...
	public TableView<School> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getSchoolData());
		try {
			ObservableList<School> filteredItems = FXCollections.observableArrayList();
			for (School item : table.getItems()) {
