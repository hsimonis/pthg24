...
public class InBookController extends Table3Controller {
	...
	@FXML
	private TableColumn<InBook, String> shortName;
	...
	@FXML
	private TableColumn<InBook, Track> track;

	@FXML
	private TableColumn<InBook, Boolean> studentPaper;
	...
	@FXML
	private TableColumn<InBook, Publisher> publisher;
	...
	@FXML
	private TableColumn<InBook, Integer> nrHyperLinks;

	@FXML
	private TableColumn<InBook, Boolean> background;

	@FXML
	private TableColumn<InBook, String> awards;
	...
	@FXML
	private TableColumn<InBook, String> language;

	@FXML
	private TableColumn<InBook, String> keywords;

	@FXML
	private TableColumn<InBook, String> abstractText;

	@FXML
	private TableColumn<InBook, String> concept;

	@FXML
	private TableColumn<InBook, String> received;

	@FXML
	private TableColumn<InBook, String> accepted;

	@FXML
	private TableColumn<InBook, String> revised;

	@FXML
	private TableColumn<InBook, String> firstOnline;

	@FXML
	private TableColumn<InBook, String> published;

	@FXML
	private TableColumn<InBook, Integer> daysToAccept;

	@FXML
	private TableColumn<InBook, Integer> daysToPublish;
	...
	class StudentPaperCallback implements Callback<TableColumn.CellDataFeatures<InBook, Boolean>, ObservableValue<Boolean>> {
		@Override
