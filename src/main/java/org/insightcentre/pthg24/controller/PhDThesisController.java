...
public class PhDThesisController extends Table3Controller {
	...
	@FXML
	private TableColumn<PhDThesis, SubType> subType;

	@FXML
	private TableColumn<PhDThesis, Track> track;

	@FXML
	private TableColumn<PhDThesis, Boolean> studentPaper;

	@FXML
	private TableColumn<PhDThesis, Link> link;
	...
	@FXML
	private TableColumn<PhDThesis, Publisher> publisher;
	...
	@FXML
	private TableColumn<PhDThesis, Integer> nrHyperLinks;

	@FXML
	private TableColumn<PhDThesis, Boolean> background;

	@FXML
	private TableColumn<PhDThesis, String> awards;
	...
	@FXML
	private TableColumn<PhDThesis, String> received;

	@FXML
	private TableColumn<PhDThesis, String> accepted;

	@FXML
	private TableColumn<PhDThesis, String> revised;

	@FXML
	private TableColumn<PhDThesis, String> firstOnline;

	@FXML
	private TableColumn<PhDThesis, String> published;

	@FXML
	private TableColumn<PhDThesis, Integer> daysToAccept;

	@FXML
	private TableColumn<PhDThesis, Integer> daysToPublish;
	...
	class StudentPaperCallback implements Callback<TableColumn.CellDataFeatures<PhDThesis, Boolean>, ObservableValue<Boolean>> {
		@Override
