...
public class ScopusCountryController extends Table3Controller {
	...
	@FXML
	private TableColumn<ScopusCountry, String> name;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getScopusCountryData());
	}

	public TableView<ScopusCountry> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getScopusCountryData());
		try {
			ObservableList<ScopusCountry> filteredItems = FXCollections.observableArrayList();
			for (ScopusCountry item : table.getItems()) {
