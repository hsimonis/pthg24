...
public class ArticleController extends Table3Controller {
	...
	@FXML
	private TableColumn<Article, String> shortName;

	@FXML
	private TableColumn<Article, Integer> nr;

	@FXML
	private TableColumn<Article, Integer> nrEdges;

	@FXML
	private TableColumn<Article, Integer> cluster;
	...
	@FXML
	private TableColumn<Article, Track> track;

	@FXML
	private TableColumn<Article, Boolean> studentPaper;
	...
	@FXML
	private TableColumn<Article, Publisher> publisher;
	...
	@FXML
	private TableColumn<Article, String> issn;
	...
	@FXML
	private TableColumn<Article, Integer> nrHyperLinks;

	@FXML
	private TableColumn<Article, Boolean> background;

	@FXML
	private TableColumn<Article, String> awards;
	...
	@FXML
	private TableColumn<Article, String> openAccess;

	@FXML
	private TableColumn<Article, OpenAccessType> openAccessType;

	@FXML
	private TableColumn<Article, Integer> nrConcepts;
	...
	@FXML
	private TableColumn<Article, Integer> wosCitations;

	@FXML
	private TableColumn<Article, Integer> wosReferences;

	@FXML
	private TableColumn<Article, Integer> scopusCitations;
	...
	@FXML
	private TableColumn<Article, Integer> maxCitations;

	@FXML
	private TableColumn<Article, Integer> rangeCitations;

	@FXML
	private TableColumn<Article, Boolean> doiStatus;

	@FXML
	private TableColumn<Article, Boolean> crossrefStatus;

	@FXML
	private TableColumn<Article, Boolean> scopusStatus;

	@FXML
	private TableColumn<Article, Boolean> wosStatus;

	@FXML
	private TableColumn<Article, Double> relevanceTitle;

	@FXML
	private TableColumn<Article, Double> relevanceAbstract;

	@FXML
	private TableColumn<Article, Double> relevanceBody;

	@FXML
	private TableColumn<Article, String> language;

	@FXML
	private TableColumn<Article, String> keywords;

	@FXML
	private TableColumn<Article, String> abstractText;

	@FXML
	private TableColumn<Article, String> concept;

	@FXML
	private TableColumn<Article, String> received;

	@FXML
	private TableColumn<Article, String> accepted;

	@FXML
	private TableColumn<Article, String> revised;

	@FXML
	private TableColumn<Article, String> firstOnline;

	@FXML
	private TableColumn<Article, String> published;

	@FXML
	private TableColumn<Article, Integer> daysToAccept;

	@FXML
	private TableColumn<Article, Integer> daysToPublish;
	...
	class StudentPaperCallback implements Callback<TableColumn.CellDataFeatures<Article, Boolean>, ObservableValue<Boolean>> {
		@Override
	...
	class DoiStatusCallback implements Callback<TableColumn.CellDataFeatures<Article, Boolean>, ObservableValue<Boolean>> {
		@Override
		public ObservableValue<Boolean> call(TableColumn.CellDataFeatures<Article, Boolean> cellData) {
	...
	class CrossrefStatusCallback implements Callback<TableColumn.CellDataFeatures<Article, Boolean>, ObservableValue<Boolean>> {
		@Override
		public ObservableValue<Boolean> call(TableColumn.CellDataFeatures<Article, Boolean> cellData) {
	...
	class ScopusStatusCallback implements Callback<TableColumn.CellDataFeatures<Article, Boolean>, ObservableValue<Boolean>> {
		@Override
		public ObservableValue<Boolean> call(TableColumn.CellDataFeatures<Article, Boolean> cellData) {
	...
	class WosStatusCallback implements Callback<TableColumn.CellDataFeatures<Article, Boolean>, ObservableValue<Boolean>> {
		@Override
		public ObservableValue<Boolean> call(TableColumn.CellDataFeatures<Article, Boolean> cellData) {
