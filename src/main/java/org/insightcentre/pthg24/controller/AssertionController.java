...
public class AssertionController extends Table3Controller {
	...
	@FXML
	private TableColumn<Assertion, String> name;

	@FXML
	private TableColumn<Assertion, Work> work;

	@FXML
	private TableColumn<Assertion, String> label;

	@FXML
	private TableColumn<Assertion, String> value;
	...
	public TableView<Assertion> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getAssertionData());
		try {
			ObservableList<Assertion> filteredItems = FXCollections.observableArrayList();
			for (Assertion item : table.getItems()) {
