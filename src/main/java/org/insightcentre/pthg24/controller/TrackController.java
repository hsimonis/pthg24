 ...
 * Generated code
 */
public class TrackController extends Table3Controller {
	@FXML
	...
	@FXML
	private TableColumn<Track, String> shortName;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getTrackData());
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getTrackData());
		try {
			ObservableList<Track> filteredItems = FXCollections.observableArrayList();
			for (Track item : table.getItems()) {
