...
public class SourceGroupController extends Table3Controller {
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getSourceGroupData());
	}

	public TableView<SourceGroup> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getSourceGroupData());
		try {
			ObservableList<SourceGroup> filteredItems = FXCollections.observableArrayList();
			for (SourceGroup item : table.getItems()) {
