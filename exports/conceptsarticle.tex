...
\href{articles/HeinzSB13.pdf}{HeinzSB13}~\cite{HeinzSB13} & completion-time, due-date, job, machine, order, precedence, preempt, release-date, resource, scheduling & RCPSP, psplib, single machine & cumulative, disjunctive &  & CHIP, Cplex, MiniZinc & satellite &  & benchmark, http:// & edge-finding, time-tabling\\
