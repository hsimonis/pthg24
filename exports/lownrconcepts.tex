...
\href{../works/HebrardALLCMR22.pdf}{HebrardALLCMR22}~\cite{HebrardALLCMR22} & 7 & order, scheduling, activity, CP &  & cumulative & Julia & Claire & deep space &  &  & sweep & \ref{a:HebrardALLCMR22} & n/a\\
\href{../works/DincbasS91.pdf}{DincbasS91}~\cite{DincbasS91} & 13 & resource, re-scheduling, constraint programming, constraint logic programming, scheduling, task, online scheduling &  &  &  & CHIP & aircraft &  &  &  & \ref{a:DincbasS91} & n/a\\
...
\href{../works/CambazardJ05.pdf}{CambazardJ05}~\cite{CambazardJ05} & 5 & scheduling, explanation, CP, Benders Decomposition, constraint logic programming, task, constraint programming, Logic-Based Benders Decomposition, CSP &  &  &  & Choco Solver &  &  &  &  & \ref{a:CambazardJ05} & n/a\\
\end{longtable}
}
